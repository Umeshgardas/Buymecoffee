  ...
  return (
    <div className='Extras_container'>
        ...
        <div className="extras_routes">
          <span onClick={myextra}  className='My_extra' style={{background: bgcolor}}>My extras</span>
        ...
        <form action="" className='extras_form_container'>
          ...
          <div className='extras_form_containers-3'>
            <div>Confirmation message  <AiTwotoneQuestionCircle /></div>
            <input type="text" placeholder="Eg : Thank you,Here's is your extra:https://m/scl..." />
          </div>
